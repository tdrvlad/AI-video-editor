...
def parse_args():
    ...
    parser.add_argument('-b', '--bold', help='Boldness of characters. Recommended: 1/10 font size.', type=int,
                        default=2)
    parser.add_argument('-bg', '--background', help='Background color. Must be 255 (white) or 0 (black).', type=int,
                        default=255)
    ...
    parser.add_argument('-q', '--quality', help='Quality of the output video. (0-10), 0 worst, 10 best.', type=int,
                        default=5)
